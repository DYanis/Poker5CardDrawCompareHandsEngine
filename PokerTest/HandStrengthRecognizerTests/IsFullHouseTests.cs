namespace PokerTest.HandStrengthRecognizerTests
{
    ...
    public class IsFullHouseTests
    {
        ...
        [TestMethod]
        public void TestIsIsFullHouseWith3JacksAnd2Queens()
        {
            ...
            Assert.AreEqual(pokerHandsChecker.IsFullHouse(hand), true);
        }

        [TestMethod]
        public void TestIsIsFullHouseWith2JacksAnd2Queens()
        {
            var card1 = new Card(CardFace.Jack, CardSuit.Spades);
            var card2 = new Card(CardFace.Jack, CardSuit.Clubs);
            var card3 = new Card(CardFace.Queen, CardSuit.Hearts);
            ...
            Hand hand = new Hand(cardList);
            Assert.AreEqual(pokerHandsChecker.IsFullHouse(hand), false);
        }

        [TestMethod]
        public void TestIsIsFullHouseWith3Jacks()
        {
            var card1 = new Card(CardFace.Jack, CardSuit.Spades);
            var card2 = new Card(CardFace.Jack, CardSuit.Clubs);
            var card3 = new Card(CardFace.Queen, CardSuit.Hearts);
        ...
        [TestMethod]
        public void TestIsIsFullHouseWith4Jacks()
        {
            var card1 = new Card(CardFace.Jack, CardSuit.Spades);
            var card2 = new Card(CardFace.Jack, CardSuit.Clubs);
